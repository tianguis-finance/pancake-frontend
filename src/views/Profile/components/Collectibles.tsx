...
import { Heading, Text, Flex, ChevronRightIcon } from '@tianguis-finance/uikit'
...
const Collectibles = () => {
  ...
  return (
    <>
      ...
      <Text as="p">
        {t('Pancake Collectibles are special ERC-721 NFTs that can be used on the Tianguis Finance platform.')}
      </Text>
      <Text as="p">
