...
import { Box, Flex, Text, Heading, useMatchBreakpoints, Link, Image } from '@tianguis-finance/uikit'
  ...
  const steps: Step[] = [
    {
      ...
      title: t('Buy Tickets'),
      subtitle: t('Prices are set when the round starts, 100 MORRALLA per ticket.'),
    },
    {
  ...
  return (
    <Box width="100%">
      ...
      <GappedFlex flexDirection={['column', 'column', 'column', 'row']}>
        <Flex flex="2" flexDirection="column">
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                {t('100% of the MORRALLA paid by people buying tickets that round goes back into the prize pools.')}
              </Text>
            </li>
          </BulletList>
          <Heading my="16px" scale="md">
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                {t(
                  'After every round, if nobody wins in one of the prize brackets, the unclaimed MORRALLA for that bracket rolls over into the next round and are redistributed among the prize pools.',
                )}
              </Text>
            </li>
          </BulletList>
          <Heading my="16px" scale="md">
            {t('MORRALLA Injections')}
          </Heading>
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                {t(
                  'An average total of QUIENSABE MORRALLA from the treasury is added to lottery rounds over the course of a week. This MORRALLA is of course also included in rollovers! Read more in our guide to ',
                )}
                <InlineLink href="https://docs.tianguis.finance/tokenomics/cake/cake-tokenomics">
                  {t('MORRALLA Tokenomics')}
                </InlineLink>
              </Text>
            </li>
          </BulletList>
      ...
      <Flex justifyContent="center" alignItems="center" flexDirection={['column', 'column', 'row']}>
        <Image width={240} height={172} src="/images/tianguis/sombrilla.png" alt="tombola bunny" mr="8px" mb="16px" />
        <Flex maxWidth="300px" flexDirection="column">
          ...
          <Text>
            ...
            <InlineLink href="https://docs.tianguis.finance/products/lottery/lottery-guide">
              {t('how to play the Tianguis Finance lottery!')}
            </InlineLink>
          </Text>
        </Flex>
      </Flex>
