...
const CakeBnbTokenSection: React.FC<TokenSectionProps> = (props) => {
  return <TokenSection primaryToken={tokens.morralla} secondaryToken={tokens.wbnb} {...props} />
}
  ...
  const renderTokenSection = () => {
    ...
    if (account && !hasProfile) {
      if (publicIfoData.status === 'finished') {
        return <Text textAlign="center">{t('Activate Tianguis Finance Profile to take part in next IFO‘s!')}</Text>
      }
      return <Text textAlign="center">{t('You need an active Tianguis Finance Profile to take part in an IFO!')}</Text>
    }
