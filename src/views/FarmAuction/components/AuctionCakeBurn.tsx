...
import { Text, Flex, Skeleton, Image } from '@tianguis-finance/uikit'
...
const AuctionCakeBurn: React.FC = () => {
  ...
  const burnedAmountAsUSD = morrallaPriceBusd.times(burnedCakeAmount)
  ...
  return (
    <Flex flexDirection={['column-reverse', null, 'row']}>
      <Flex flexDirection="column" flex="2">
        {burnedCakeAmount !== 0 ? (
          <Balance fontSize="64px" bold value={burnedCakeAmount} decimals={0} unit=" MORRALLA" />
        ) : (
      ...
      <Image width={350} height={320} src="/images/burnt-cake.png" alt={t('Burnt MORRALLA')} />
    </Flex>
  )
}
