...
import { Text, Heading, Card, CardHeader, CardBody, Flex, Link, Box } from '@tianguis-finance/uikit'
            ...
            <FoldableText title={t('Step 1: Submit application')} mt="24px">
              <Box display="inline">
                <Text display="inline" color="textSubtle">
                  {t(
                    'Projects can submit an application to sponsor a yield farm and/or pool on Tianguis Finance via the ',
                  )}
                </Text>
            ...
            <FoldableText title={t('Step 2: Await whitelisting')} mt="24px">
              <Box color="textSubtle">
                <Text color="textSubtle" mb="4px">
                  {t('The Tianguis Finance team will try to respond within a week.')}
                </Text>
                <List>
                  <FaqLi>
                    {t(
