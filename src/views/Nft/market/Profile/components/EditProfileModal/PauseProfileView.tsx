...
import { AutoRenewIcon, Button, Checkbox, Flex, InjectedModalProps, Text } from '@tianguis-finance/uikit'
...
const PauseProfilePage: React.FC<PauseProfilePageProps> = ({ onDismiss }) => {
  ...
  return (
    <>
      ...
      <Text as="p" color="textSubtle" mb="24px">
        {t('Cost to reactivate in the future: %cost% MORRALLA', { cost: formatBigNumber(numberCakeToReactivate) })}
      </Text>
