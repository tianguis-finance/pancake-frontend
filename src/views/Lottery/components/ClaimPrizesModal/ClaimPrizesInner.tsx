...
import { Flex, Button, Text, AutoRenewIcon, PresentWonIcon } from '@tianguis-finance/uikit'
...
const ClaimInnerContainer: React.FC<ClaimInnerProps> = ({ onSuccess, roundsToClaim }) => {
  ...
  const dollarReward = cakeReward.times(morrallaPriceBusd)
      ...
      if (receipt.status) {
        toastSuccess(
          ...
          <ToastDescriptionWithTx txHash={receipt.transactionHash}>
            {t('Your MORRALLA prizes for round %lotteryId% have been sent to your wallet', { lotteryId })}
